...
loadResources(function (err) {
  ...
  */
  router.get('/parrotTem/:id', function (req, res, next) {
  ...
  router.get('/parrotHum/:id', function (req, res, next) {

  })
  router.get('/parrotLum/:id', function (req, res, next) {

  })
  router.get('/parrotBat/:id', function (req, res, next) {
  ...
  */
  router.post('/parrot/:id', function (req, res, next) {
    //  You can find the id stored on req.params.id
